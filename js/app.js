...
$(document).ready(function() {
    ...
    $('.box').on("click", function setSquare(){
      ...
      if(!spaces[boxNum] && game){
        ...
        if(spaces[1] === spaces[4] && spaces[7] === spaces[1] && !!spaces[1]){
          alert(spaces[1] + " player wins!");
          game = false;
        }
        if((spaces[2] === spaces[5] && spaces[2] === spaces[8] && !!spaces[2])||(spaces[2] === spaces[4] && spaces[2] === spaces[6] && !!spaces[2])){
          alert(spaces[2] + " player wins!");
          game = false;
        }
        if(spaces[3]  === spaces[4] && spaces[3] === spaces [5] && !!spaces[3]){
